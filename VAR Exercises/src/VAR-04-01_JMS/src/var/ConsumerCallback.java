...
public class ConsumerCallback implements MessageListener {

	public static void main(String[] args) {
		ConsumerCallback consumer = null;
		try {
			long wait = Long.parseLong(args[0]);
			consumer = new ConsumerCallback();
			Thread.sleep(wait);
		} catch (Exception e) {
	...
	public ConsumerCallback() throws NamingException, JMSException {
